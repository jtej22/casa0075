...
```{r echo=FALSE, out.width = "85%", fig.align='center', cache=TRUE, fig.cap="Source: [Greece-is](https://www.greece-is.com/news/watch-infrared-camera-footage-of-athens-heatwave-as-archeological-sites-close/)"}
knitr::include_graphics('images/heatwave.jpg')
```
...
::: callout-tip
## Young's thought
1. Need to add the specific formula for calculating images?
2. Add the Sensor price?
:::

#### 2.2.4.2. Land Surface Temperature (LST)

```{r echo=FALSE, out.width = "85%", fig.align='center', cache=TRUE}
knitr::include_graphics('images/3_LST_DayTime-01.png')
```

```{r echo=FALSE, out.width = "85%", fig.align='center', cache=TRUE, fig.cap="Source: [WRI-INDIA](https://wri-india.org/blog/measuring-and-mapping-heatwave)"}
knitr::include_graphics('images/4_LST_NightTime-01.png')
```

- the radiative skin temperature of the land derived from **solar radiation**

- measures **the emission of thermal radiance** from the land surface where the incoming solar energy interacts with and heats the ground, or the surface of the canopy in vegetated areas (Source: [Khan et al](https://www.sciencedirect.com/science/article/pii/B9780128196694000027))
...
7. https://www.mdpi.com/2072-4292/11/20/2403
8. https://www.mdpi.com/2072-4292/13/3/538
=======
---
title: "Heat wave and slums in Ahmedabad, India"
subtitle: "CASA0075"
...
5.  https://www.mdpi.com/1660-4601/14/4/357
6.  https://www.researchgate.net/profile/Manat-Srivanit/publication/286451131_Assessing_the_Impact_of_Urbanization_on_Urban_Thermal_Environment_A\_Case_Study_of_Bangkok_Metropolitan/links/566a337c08aea0892c49ec14/Assessing-the-Impact-of-Urbanization-on-Urban-Thermal-Environment-A-Case-Study-of-Bangkok-Metropolitan.pdf
>>>>>>> 7a860bd4e46496d1fdb37e2359f6201e7390752c
